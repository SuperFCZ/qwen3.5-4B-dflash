...
| 数据集文件 | 完成 / 选择 | 接受 / 提出 | 接受率 | token/投机轮 | 普通 gen tok/s | DFlash gen tok/s | Decode 加速比 |
|---|---:|---:|---:|---:|---:|---:|---:|
...
| Prompt | 输入 token | 接受 / 提出 | 接受率 | token/投机轮 | DFlash gen tok/s | Decode 加速比 |
|---|---:|---:|---:|---:|---:|---:|
| zh_explain | 28 | 101 / 391 | 25.83% | 4.70 | 64.33 | 2.31× |
| zh_plan | 29 | 63 / 944 | 6.67% | 1.95 | 27.30 | 0.96× |
| math | 47 | 107 / 289 | 37.02% | 6.35 | 85.50 | 3.11× |
| code | 46 | 100 / 416 | 24.04% | 4.54 | 61.98 | 2.22× |
| translate | 59 | 108 / 290 | 37.24% | 6.35 | 85.43 | 3.11× |
| summary | 59 | 91 / 517 | 17.60% | 3.43 | 47.33 | 1.68× |
| en_explain | 34 | 99 / 380 | 26.05% | 4.54 | 62.01 | 2.22× |
| creative | 42 | 98 / 436 | 22.48% | 4.23 | 57.98 | 2.07× |
...
| Prompt | 输入 token | 接受 / 提出 | 接受率 | token/投机轮 | DFlash gen tok/s | Decode 加速比 |
|---|---:|---:|---:|---:|---:|---:|
| long_zh_summary | 983 | 86 / 565 | 15.22% | 3.02 | 28.38 | 1.48× |
| long_zh_qa | 998 | 97 / 411 | 23.60% | 4.23 | 34.97 | 2.07× |
| long_zh_plan | 1001 | 94 / 484 | 19.42% | 3.85 | 33.03 | 1.88× |
| long_en_analysis | 1008 | 93 / 487 | 19.10% | 3.63 | 31.87 | 1.78× |
| long_en_math | 978 | 99 / 401 | 24.69% | 4.38 | 35.61 | 2.15× |
| long_zh_code | 984 | 98 / 400 | 24.50% | 4.23 | 34.92 | 2.07× |
| long_zh_translate | 1004 | 99 / 392 | 25.26% | 4.54 | 36.36 | 2.22× |
| long_zh_extract | 1024 | 58 / 982 | 5.91% | 1.81 | 19.68 | 0.89× |
| long_en_compare | 980 | 111 / 243 | 45.68% | 7.47 | 46.73 | 3.66× |
| long_en_timeline | 1022 | 99 / 424 | 23.35% | 4.38 | 35.60 | 2.15× |
| long_en_rules | 1007 | 107 / 299 | 35.79% | 6.05 | 42.30 | 2.97× |
| long_en_story | 987 | 98 / 398 | 24.62% | 4.38 | 35.64 | 2.15× |

### 汇总

| 输入组 | 完成 / 选择 | 接受 / 提出 | 加权接受率 | token/投机轮 | 普通 gen tok/s | DFlash gen tok/s | Decode 加速比 |
|---|---:|---:|---:|---:|---:|---:|---:|
| 短输入 | 8 / 8 | 767 / 3663 | 20.94% | 3.98 | 28.45 | 54.71 | 1.95× |
| 约 1K 输入 | 12 / 12 | 1139 / 5486 | 20.76% | 3.88 | 22.74 | 33.17 | 1.90× |
| 全部 | 20 / 20 | 1906 / 9149 | 20.83% | 3.92 | 24.72 | 39.37 | 1.92× |
...
| Draft | 完成 / 选择 | 接受率 | token/投机轮 | 普通 gen tok/s | DFlash gen tok/s | Decode 加速比 vs 普通 | Draft ms/call | Verify ms/call |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| FP16 | 20 / 20 | 20.83% | 3.92 | 24.72 | 39.37 | 1.92× | 20.13 | 51.21 |
| W4A16 | 20 / 20 | 18.61% | 3.60 | 24.72 | 7.85 | N/A | 310.08 | 51.25 |
| W8A16 | 20 / 20 | 21.03% | 3.93 | 24.72 | 9.06 | N/A | 283.63 | 51.28 |

相对同轮 FP16，W4/W8 的接受率分别变化 **-2.22 / +0.20 个百分点**，
生成吞吐比为 **0.20× / 0.23×**。W4/W8 缺少 Decode 分项，Decode 加速比记为 `N/A`。
输出状态为 `PASS_WITH_DIFFERENCES`。

### 原生 WeightQuantBatchMatmulV2 实现

`gdr-lengths-waw8h36d`：短输入 8 条、约 1K 输入 12 条。

| Draft | 分组 | 完成 / 选择 | 接受率 | token/投机轮 | 普通 gen tok/s | DFlash gen tok/s | Decode 加速比 | Draft ms/call | Verify ms/call |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| FP16 | all | 20 / 20 | 20.83% | 3.92 | 24.74 | 39.35 | 1.92× | 20.22 | 51.14 |
| FP16 | short | 8 / 8 | 20.94% | 3.98 | 28.47 | 54.61 | 1.95× | 20.00 | 51.11 |
| FP16 | long | 12 / 12 | 20.76% | 3.88 | 22.75 | 33.17 | 1.90× | 20.32 | 51.15 |
| W4A16 | all | 20 / 20 | 18.96% | 3.65 | 24.74 | 19.13 | 0.87× | 94.68 | 51.38 |
| W4A16 | short | 8 / 8 | 18.70% | 3.64 | 28.47 | 24.79 | 0.87× | 94.48 | 51.34 |
| W4A16 | long | 12 / 12 | 19.14% | 3.65 | 22.75 | 16.60 | 0.87× | 94.77 | 51.40 |
| W8A16 | all | 20 / 20 | 21.03% | 3.93 | 24.74 | 25.41 | 1.19× | 63.52 | 51.25 |
| W8A16 | short | 8 / 8 | 21.20% | 3.98 | 28.47 | 34.34 | 1.21× | 63.28 | 51.23 |
| W8A16 | long | 12 / 12 | 20.91% | 3.90 | 22.75 | 21.66 | 1.18× | 63.63 | 51.26 |

相对同轮 FP16 Draft：W4/W8 接受率分别变化 **-1.87 / +0.20 个百分点**，
Decode 时间加速比分别为 **0.45× / 0.62×**，两者均匹配 20 条。
